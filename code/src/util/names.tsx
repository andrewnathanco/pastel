import { calculateDifference, hexToRgb } from "./colors";
...
export function getColorName(color: string): [string, string] {
  color = color.toLocaleUpperCase();

  let { r, g, b } = hexToRgb(color);

  let found: [string, string] = ["#000000", "Black"];
  let dist = -1;

  for (let [hex, name] of names) {
    hex = "#" + hex;
    if (color == hex) return [hex, name];
